...
## Project Structure
    ...
    ├── resurgence_kpi_dash_30924  # Django project configurations
...
1. Clone this repo and `cd resurgence_kpi_dash_30924`
...
2. Clone this repo and `cd resurgence_kpi_dash_30924`
